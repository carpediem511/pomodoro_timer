...
const Timer = () => {
	const [totalMinutes, setTotalMinutes] = useState<number>(1); // общая продолжительность в минутах
	...
	return (
		<>
			<div className="text-center mt-8">
				<h2 className={`text-2xl mb-6 font-bold ${timerType === "work" ? "text-red-700" : "text-green-600"}`}>
					{timerTitle}
				</h2>
				<CircularProgressbar
